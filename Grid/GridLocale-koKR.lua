...
local strings_koKR = {
	...
	["Use custom bar colors"] = "Utiliser des couleurs personnalisées.",
	["Desc custom bar colors"] = "Permet de choisir la couleur de la barre de vie et du fond des cellules",
	["Custom Color 1"] = "Couleur de la barre de vie.",
	["Desc Custom Color 1"] = "Choisissez la couleur à utiliser",
	["Custom Color 2"] = "Couleur du fond de la cellule",
	["Desc Custom Color 2"] = "Choisissez la couleur à utiliser",
