...
function GridLayoutPartyClass.prototype:SetOrientation(horizontal)
	...
	local anchor, anchorf1, anchorf2, anchorp1, anchorp2, point, xOffset, yOffset
	...
	self.partyPetFrame:SetPoint(anchorp1, self.partyFrame, anchorp2, xOffset, yOffset)
